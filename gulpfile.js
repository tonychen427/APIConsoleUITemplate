...
gulp.task('buildCSS', function() {
	gulp.src('app/lib/8x8/**/*.*').pipe(gulp.dest('dist/lib/8x8/'));
	var cssFiles = ['app/lib/bower_components/bootstrap/dist/css/bootstrap.min.css',
	'app/lib/bower_components/font-awesome/css/font-awesome.min.css',
	'app/lib/customize/adminlte-bower/dist/css/AdminLTE.min.css',
	'app/lib/customize/adminlte-bower/dist/css/skins/skin-blue-light.min.css',
	'app/css/portal.css'];
...
gulp.task('fonts', function() {
	return gulp.src(mainBowerFiles().concat('app/lib/bower/font-awesome/fonts/**/*'))
